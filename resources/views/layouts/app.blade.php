                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <li class="position-static"><a href="#">Danh mục <i class="fi-rs-angle-down"></i></a>
                                        <ul class="mega-menu">
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                ...
                                                <ul>
                                                    <li><a href="product-details.html">Truyện chữ Hàn Quốc</a></li>
                                                    <li><a href="product-details.html">Truyện chữ Nhật Bản</a></li>
                                                    <li><a href="product-details.html">Truyện chữ Phương Tây</a></li>
                                                    <li><a href="product-details.html">Truyện chữ Việt Nam</a></li>
                                                    <li><a href="product-details.html">Truyện chữ Trung Quốc</a></li>
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                ...
                                                <ul>
                                                    <li><a href="product-details.html">Truyện tranh Hàn Quốc</a></li>
                                                    <li><a href="product-details.html">Truyện tranh Nhật Bản</a></li>
                                                    <li><a href="product-details.html">Truyện tranh Phương Tây</a></li>
                                                    <li><a href="product-details.html">Truyện tranh Việt Nam</a></li>
                                                    <li><a href="product-details.html">Truyện tranh Trung Quốc</a></li>
                                                </ul>
                                            </li>
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                    ...
                                    <li><a href="about.html">Về website</a></li>                            
